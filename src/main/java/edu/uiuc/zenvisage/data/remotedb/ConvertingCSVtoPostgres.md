...
CREATE TABLE zenvisage_metafilelocation (database TEXT, metafilelocation TEXT);

INSERT INTO zenvisage_metafilelocation (database, metafilelocation)
VALUES
('real_estate', 'real_estate.txt'),('cmu', 'cmuwithoutidschema.txt'),('cmutesting', 'cmuwithoutidschema.txt'), ('sales','sales.txt');
